      ...
      <div class="container-fluid">
        <div class="quick-actions_homepage">
          <ul class="quick-actions">
            ...
            <li class="bg_ly"> <a href="room.html"> <i class="icon-inbox"></i><span class="label label-success">101</span> Room</a> </li>
            <li class="bg_lo"> <a href="bookings.html"> <i class="icon-th"></i> Bookings</a> </li>
            
    <li class="bg_ls"> <a href="chat.html"> <i class="icon-tint"></i>Chat</a> </li>
          </ul>
        </div>
    <!--End-Action boxes-->    
          ...
          <div class="widget-box">
            ...
            <div class="widget-content" >
              <div class="row-fluid">
                ...
                <div class="span3">
                  <ul class="site-stats">
                    <li class="bg_lh"><i class="icon-user"></i> <strong>2540</strong> <small>Total Guest</small></li>
                    <li class="bg_lh"><i class="icon-plus"></i> <strong>120</strong> <small>New Guest </small></li>
                    <li class="bg_lh"><i class="icon-shopping-cart"></i> <strong>101</strong> <small>Total Room</small></li>
                    <li class="bg_lh"><i class="icon-tag"></i> <strong>9540</strong> <small>Total Payment</small></li>
                    <li class="bg_lh"><i class="icon-repeat"></i> <strong>10</strong> <small>Pending Payment</small></li>
                    <li class="bg_lh"><i class="icon-globe"></i> <strong>8540</strong> <small>Online Bookings</small></li>
                  </ul>
                </div>
              </div>
            </div>
